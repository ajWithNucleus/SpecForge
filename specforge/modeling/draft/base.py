...
class Eagle3DraftModel(PreTrainedModel, ABC):
    ...
    def freeze_lm_head(self) -> None:
        ...
        This is typically used when sharing the lm_head with the target model.
        """
    ...
    def load_lm_head(
        ...
        Args:
            ...
            lm_head_key (str): The key of the lm_head weight in the model checkpoint.
        """
        if not hasattr(self, "lm_head"):
            raise AttributeError(
                "lm_head not found in the draft model. Make sure the model has an lm_head attribute."
            )
